...
const TASLP2020Page = ({ pageContext }) => {
  const {
    breadcrumb: { crumbs },
  } = pageContext;

  return (
    <Layout name="Learning and Evaluation Methodologies for Polyphonic Music Sequence Prediction with LSTMs" crumbs={crumbs}>
      <section className="section">
        <div className="column is-one-third">
          <ParallelogramHeader text="IEEE TASLP 2020 Paper" backgroundColor="primary" textColor="white"/>
        </div>
        <div className="lowerPadding"></div>
        
        <div className="content">
          <h1>Learning and Evaluation Methodologies for Polyphonic Music Sequence Prediction with LSTMs</h1>
...
export default TASLP2020Page;
export const Head = () => <title>Learning and Evaluation Methodologies for Polyphonic Music Sequence Prediction with LSTMs</title>