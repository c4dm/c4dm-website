...
const Research = ({pageContext}) => {
  ...
  const data = useStaticQuery(graphql`
  {
    ...
    people: allMarkdownRemark(
      filter: {fields: {category: {eq: "people"}}, frontmatter: {themes: {eq: "comma"}}}
    ) {
        ...
        <Layout name="AudioEng" crumbs={crumbs}>
            ...
            <div className="lowerPadding">
                <div className="column is-one-half">
                    <ParallelogramHeader text="Communication Acoustics Lab" backgroundColor="primary" textColor="white"/>
                </div>
            </div>
            <div 
             className="content"
